...
<div class="drawer drawer-end">
  <input id="media-settings" type="checkbox" class="drawer-toggle" />
  <div
    class="drawer-content flex flex-col flex-1 space-y-2 ${fullScreen
      ? ''
  ...
  >
    ...
    >
      ...
      >
      <div class="btn btn-accent btn-circle p-3">
        <label for="media-settings">
          <Icon src={Settings} />
        </label>
      </div>
    </div>
  ...
  <div class="drawer-side">
    <label for="media-settings" class="drawer-overlay" />
    <form
    ...
    >
      ...
      <button class="btn btn-accent prose" type="submit">SAVE</button>
    </form>
  </div>
</div>
